...
<template>
    <nav
        class="w-full fixed z-20 bg-light-primary border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-dark-primary"
        :class="{
    ...
    >
        ...
        >
            <a href="#" class="flex items-center">
                <img src="/img/logo.svg" class="h-6 mr-3 sm:h-9" alt="Logo" />
                <span
                ...
                >
                    <li v-for="(navigation, index) in navigations" :key="index">
                        <a
                            ...
                            class="block py-2 pl-3 pr-4 text-light-tail-500 rounded dark:text-dark-navy-100 hover:text-light-tail-100 dark:hover:text-white"
                            aria-current="page"
                            >{{ navigation.name }}</a
                        >
                    </li>
